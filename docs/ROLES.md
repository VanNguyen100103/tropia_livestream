...
> **Yêu cầu nghiệp vụ (chủ Đăng, 01/06/2026).** Khác Shopee — nơi *ai cũng*
> live bán hàng quá dễ, dẫn tới hàng dỏm kém chất lượng — ở Tropia **chỉ chủ
> shop, nhân viên được cấp quyền live của shop, hoặc cộng tác viên (CTV) đã
> được duyệt** mới được lên sóng. Đây là **điểm khác biệt cốt lõi** của nền
> tảng. Toàn bộ tài liệu này xoay quanh việc enforce đúng nguyên tắc đó.
