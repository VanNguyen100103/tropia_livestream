-- Migration 0001 — initial schema (20 tables + view + triggers + RPCs).
-- Ported from the original Node.js + Supabase backend.
-- Snake_case columns, UUID PKs, TIMESTAMPTZ everywhere.
--
-- Rollback: 0001_initial_schema.down.sql (drops everything).
