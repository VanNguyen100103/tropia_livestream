...
import 'package:tropia/features/live/screens/live_setup_screen.dart';
import 'package:tropia/features/live/screens/live_stream_screen.dart';
import 'package:tropia/features/live/widgets/live_card_widget.dart';
import 'package:tropia/features/user/providers/user_provider.dart';
import 'package:tropia/features/user/screens/login_screen.dart';
          ...
          if (context.watch<UserProvider>().canHostLive)
            GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute<void>(builder: (_) => const LiveSetupScreen()),
                );
              },
              child: Container(
  ...
  void _openStream(LiveStream stream) {
    ...
    Navigator.of(context).push(
      PageRouteBuilder<void>(
        pageBuilder: (_, __, ___) => LiveStreamScreen(streamId: stream.id),
