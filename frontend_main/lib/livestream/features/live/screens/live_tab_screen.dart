...
import 'package:tropia_mobile_app_android/livestream/features/live/screens/live_stream_screen.dart';
import 'package:tropia_mobile_app_android/livestream/features/live/widgets/live_card_widget.dart';
...
import 'package:tropia_mobile_app_android/livestream/live_tab_entry.dart' show liveScope;
...
class _LiveTabScreenState extends State<LiveTabScreen>
            ...
            Expanded(
              child: Consumer<LiveProvider>(
                builder: (context, provider, _) {
                  ...
                  if (provider.errorMessage != null) return _buildErrorState(provider);
  ...
  Widget _buildTopBar() {
    ...
    return Container(
      color: Colors.black,
      padding: EdgeInsets.only(top: topPadding, left: AppSizes.sm, right: AppSizes.sm),
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          // Bên phải: tạo live (seller) hoặc nút +
              ...
              onTap: () {
                ...
                Navigator.of(context).push(
                  MaterialPageRoute<void>(
                    // Re-provide the Live tab's provider scope — this route is
                    // pushed onto the root Navigator, outside LiveTabEntry's
                    // MultiProvider, so LiveSetupScreen's Consumer<LiveProvider>
              ...
              child: Container(
                ...
                child: const Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 4),
                    Text('Live', style: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w600)),
                  ],
                ),
              ),
            )
                ...
                (context, index) => Column(
                  ...
                  children: [
                    LiveCardWidget(
                      ...
                      onFollowTap: () => context.read<LiveProvider>().toggleFollow(streams[index].id),
                    ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Text(
                  'ĐANG PHÁT',
                  style: TextStyle(color: Colors.white, fontSize: AppSizes.fontXs, fontWeight: FontWeight.w800),
                ),
              ],
            ),
          ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Container(height: 30, width: 80, decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(AppSizes.radiusFull))),
                  ],
                ),
              ),
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            const Icon(Icons.signal_wifi_bad, size: AppSizes.iconXl, color: AppColors.textHint),
            const SizedBox(height: AppSizes.md),
            Text(
              provider.errorMessage ?? AppStrings.liveError,
              textAlign: TextAlign.center,
              style: const TextStyle(color: AppColors.textSecondary, fontSize: AppSizes.fontMd),
            ),
    ...
    if (!AuthService.instance.isSignedIn) {
      showDialog<void>(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: const Text('Bạn cần đăng nhập để xem livestream và tương tác với người bán.'),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(ctx),
              child: const Text('Để sau'),
