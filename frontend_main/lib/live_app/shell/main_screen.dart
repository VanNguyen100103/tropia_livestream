...
import 'package:tropia_mobile_app_android/live_app/features/home/screens/home_screen.dart';
import 'package:tropia_mobile_app_android/live_app/features/cart/providers/cart_provider.dart';
import 'package:tropia_mobile_app_android/live_app/features/cart/screens/cart_screen.dart';
...
import 'package:tropia_mobile_app_android/live_app/features/user/screens/profile_screen.dart';
import 'package:tropia_mobile_app_android/live_app/features/video/providers/video_provider.dart';

const _tag = 'MainScreen';

/// Public shell entry for the standalone live_app experience.
///
/// Owns the live_app Provider tree so the bottom-nav `Consumer<CartProvider>`
/// and the tab screens (LiveTabScreen / CartScreen / ProfileScreen) can resolve
/// their providers no matter how this screen is pushed.
///
/// [LoginScreen] reaches MainScreen via `pushAndRemoveUntil(..., (_) => false)`,
/// which tears down DashboardPage and the [LiveTabEntry] MultiProvider that
/// normally hosts these providers. Without this wrapper the nav bar crashes with
/// "Could not find the correct `Provider<CartProvider>`". Mirrors the wiring in
/// [LiveTabEntry] (fresh instances, since the host tree is gone by this point).
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        // cart on update (mirrors LiveTabEntry / the standalone main.dart).
          ...
          child: Row(
            ...
            children: [
              ...
              Consumer<CartProvider>(
                builder: (_, cart, _) => _buildNavItem(
                  index: 3,
