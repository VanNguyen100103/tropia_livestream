...
class ShopProvider extends ChangeNotifier {
  ...
  /// Cập nhật logo/avatar shop cục bộ sau khi upload thành công. Backend đã lưu
  /// `logo_url` vào DB trong cùng request upload, đây chỉ là để UI phản hồi ngay
  /// mà không cần tải lại toàn bộ thông tin shop.
  void setLogo(String url) {
    if (_myShop == null) return;
    _myShop = _myShop!.copyWith(logoUrl: url, avatarUrl: url);
    notifyListeners();
  }
